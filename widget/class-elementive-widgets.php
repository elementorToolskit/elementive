...
class Elementive_Widgets {
	...
	public function widget_scripts() {
        wp_register_script( 'elementive-scripts', plugins_url( '/assets/js/hello-world.js', __FILE__ ), [ 'jquery' ], false, true );
	}
	/**
