...
(function ($) {
  ...
  var elementive_starter = {
     ...
     * Before After JS
     */
    run_before_after: function run_before_after() {
  ...
  $(window).on('resize', function () {//elementive_starter.run_progress_bar();
  });
