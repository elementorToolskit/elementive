<?php 
namespace Elementive\Modules\Header_Footer\Theme_Hooks;
...
class Oceanwp {
    ...
    public function add_plugin_header_markup(){
		do_action('elementive/template/before_header');
		echo '<div class="ekit-template-content-markup ekit-template-content-header">';
			echo \Elementive\Utils::render($this->elementor->frontend->get_builder_content_for_display( $this->header ));
		echo '</div>';
		do_action('elementive/template/after_header');
    }
	...
	public function add_plugin_footer_markup(){
		do_action('elementive/template/before_footer');
		echo '<div class="ekit-template-content-markup ekit-template-content-footer">';
			echo \Elementive\Utils::render($this->elementor->frontend->get_builder_content_for_display( $this->footer ));
		echo '</div>';
		do_action('elementive/template/after_footer');
	}
